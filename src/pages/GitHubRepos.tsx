...
const GitHubRepos = () => {
    ...
    const repoNames = useMemo(() => ['analytic', 'angular-dashboard-framework', 'angular-mvp', 'change-track','d-trade', 'global-qa', 'itn-md-library', 'mfe-dashboard', 'npm-seed','portfolio'], []); // Adjust repo names as needed
